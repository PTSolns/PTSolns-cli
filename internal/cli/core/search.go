...
import (
	...
	"github.com/PTSolns/ptsolns-cli/internal/cli/feedback/result"
	"github.com/PTSolns/ptsolns-cli/internal/cli/feedback/table"
...
func runSearchCommand(ctx context.Context, srv rpc.ArduinoCoreServiceServer, args []string, allVersions bool) {
	...
	logrus.Infof("Executing `ptsolns-cli core search` with args: '%s'", arguments)
